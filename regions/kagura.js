...
var PLACES = [
	...
	{ id:'ruins', box:[22,16], name:'The Standing Stones', x:142, y:92, island:'Kogarashi', tier:'RU', kind:'gym', gym:'PSYCHIC GYM',
	  blurb:'Nine stones in a ring on the heath, older than the castle and a good deal older than anyone\'s explanation of them. They are aligned on something, and nobody agrees on what - except the Psychic gym, which meets inside the ring and seems to know.',
	  facts:['Psychic Gym, inside the ring','Nine stones, one fallen','Older than the castle','Aligned on something'],
	  catch:['Psychic','Rock','Ghost','Fairy'],
	  doing:['Challenge the Psychic gym','Count them twice','Stand in the middle at dusk','Compare notes with the castle library'],
...
var PLANS = {
	...
	var GYMS = {
		...
		ruins:    { type:'Psychic',  badge:'Crown Badge',    leader:'',
		            puzzle:'The nine stones are teleport points, and the ring they make is the crown. Step to the wrong stone and you begin again at the fallen ninth.' },
